...
import com.codinglemonsbackend.Payloads.RunCodeRequestPayload;

@Service
public class SubmissionServiceImplOld {
    ...
    public CodeSubmissionResponsePayload handleSubmission(RunCodeRequestPayload request, Boolean submission){
        ...
        //Checking for code output for any error
        if (!codeOutput.getError().isEmpty()) {
            CodeSubmissionResponsePayload response = CodeSubmissionResponsePayload.builder()
                .runSuccess(false)
                .error(codeOutput.getStderr())
                .statusMsg(StatusMessage.ERR)
                .build();  
        ...
        return CodeSubmissionResponsePayload.builder()
                .runSuccess(true)
    ...
    private void saveSubmission(RunCodeRequestPayload request, CodeSubmissionResponsePayload codeSubmissionResponse) {
